@extends('pages.back.admin.master', ['titre' => 'EDITION DE PRESTATAIRES'])
@section('style')
@endsection
@section('admin-content')
    ...
    <div class="card">
        <div class="p-3 d-flex justify-content-between">
            <div>
                <a class="btn btn-outline-danger" href="{{ route('providers.index') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <select class="form-select-domiciliation form-control" name="domiciliation"
                                                    id="domiciliation">
                                                    <option value="Locale"
                                                        {{ $provider->domiciliation == 'Locale' ? 'selected' : '' }}
                                                        selected>
                                                        Locale</option>
                                                    <option value="Etrangere"
                                                        {{ $provider->domiciliation == 'Etrangere' ? 'selected' : '' }}>
                                                        Etrangère</option>
                                                </select>
                                                @error('domiciliation')
                                            ...
                                            <div class="form-group">
                                                <select class="form-select-reglement form-control" name="reglement"
                                                    ...
                                                    <option value="Prepaye"
                                                        {{ $provider->reglement == 'Prepaye' ? 'selected' : '' }} selected>
                                                        Prepayé</option>
                                                    <option value="Postpaye"
                                                        {{ $provider->reglement == 'Postpaye' ? 'selected' : '' }}>
                                                        Postpayé</option>
                                                </select>
                                                @error('reglement')
                                                    <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="hidden" id="tvaValue" value="{{ $provider->taxe_tva }}">
                            ...
                            <div class="form-group">
                                <div class="mb-3 col-12">
                                    ...
                                    @if (isset($provider->exo_path))
                                        ...
                                        <input type="hidden" id="exo_path" value="{{ $provider->exo_path }}">
                                    @else
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control custom-file-input"
                                                        ...
                                                        value="{{ $provider->rcc_number }}" />
                                                    <div class="input-group-append">
                                                        @if (isset($provider->rcc_path))
                                                            <label
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control custom-file-input"
                                                        ...
                                                        oninput="convertToUppercase(this)"
                                                        value="{{ $provider->rcm_number }}" />
                                                    <div class="input-group-append">
                                                        @if ($provider->rcm_path)
                                                            <label
                                                                class="input-group-text btn btn-success custom-file-label"
                                                                for="rcm_file">
                                                                <i class="fas fa-recycle"></i> Remplacer
                                ...
                                <div class="input-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="regime" id="inlineRadio1"
                                            value="TEE" {{ $provider->regime == 'TEE' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="regime" id="inlineRadio2"
                                            value="RME" {{ $provider->regime == 'RME' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="regime" id="inlineRadio3"
                                            value="RSI" {{ $provider->regime == 'RSI' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="email-id-vertical" class="form-control"
                                                name="email" placeholder="Email" value="{{ $provider->email }}">
                                            @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="solde" class="form-control" name="balance"
                                                placeholder="Solde départ" value="{{ $provider->balance }}">
                                            @error('balance')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control"
                                                name="country" placeholder="Pays" value="{{ $provider->country }}">
                                            @error('country')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control"
                                                name="city" placeholder="Ville" value="{{ $provider->city }}">
                                            @error('city')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
