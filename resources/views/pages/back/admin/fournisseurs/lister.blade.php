                            ...
                            <div class="card mb-0">
                                <div class="">
                                    <div class="col-md-12 d-flex justify-content-start px-2 py-3">
                                        <a href="{{ route('suppliers.create') }}" class="btn btn-outline-primary"><i
                                                class="fa fa-plus"></i> fournisseur</a>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0  table-hover display" id="datatable" id="table1">
                                            ...
                                            <tbody>
                                                @isset($fournisseurs)
                                                    @foreach ($fournisseurs as $key => $client)
                                                        <tr>
                                                            <td class="d-none">{{ $client->id }}</td>
                                                            <td>{{ $client->name }}</td>
                                                            <td>{{ $client->domiciliation }}</td>
                                                            ...
                                                            <td class="">
                                                                ...
                                                                <a type="button" class="btn btn-outline-warning"
                                                                    href="{{ route('suppliers.edit', $client->id) }}">
                                                        ...
                                                        <div class="modal fade" id="show{{ $client->id }}"
                                                                        ...
                                                                        <form class="form-horizontal">
                                                                            ...
                                                                            <div class="form-control-group mb-4">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div
                                                                                        class="form-control-group col-md-3 mb-3">
                                                                                    ...
                                                                                    <div
                                                                                        class="form-control-group col-md-4 mb-3">
                                                                                        <label
                                                                                            for="tva_status">Exonération</label>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div
                                                                                        class="form-control-group col-md-6 mb-3">
                                                                                ...
                                                                                @if (isset($client->rcc_number) || isset($client->rcm_number))
                                                                                    <div class="row">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div
                                                                                        class="form-control-group col-md-3 mb-3">
                                                                                        <label
                                                                                            for="municipality">Commune</label>
                                                                                        <input class="text-center form-control"
                                                        ...
                                                        <div class="modal-info me-1 mb-1 d-inline-block">
                                                            <!--warning theme Modal -->
                                                            <div class="modal fade text-left" id="edit{{ $client->id }}"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-warning">
                                                                            <h5 class="modal-title white"
                                                                                id="myModalLabel140">
                                                                                <i class="bi bi-border-width"></i> Édition de
                                                                                client
                                                                            </h5>
                                                                        ...
                                                                        <form
                                                                            action="{{ route('suppliers.update', $client->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PUT')
                                                        ...
                                                        <div class="modal fade" id="delete{{ $client->id }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Voulez-vous vraiment supprimer le fournisseur <strong
                                                                            class="text-danger">{{ $client->name }}</strong>?
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('suppliers.destroy', $client->id) }}"
                                                                            method="Post">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
