                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control"
                                                name="pays" placeholder="Pays" value="{{ $supplier->country }}">
                                            @error('pays')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control"
                                                name="ville" placeholder="Ville" value="{{ $supplier->city }}">
                                            @error('ville')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
    ...
    <script>
        function statusChange() {
            ...
            if (selectedValue === 'Oui') {
                // Si exo_file existe, alors il ne faut pas rendre le champ requis
                if (!exo_file) {
