@extends('pages.back.admin.master', ['titre' => 'ENREGISTREMENT DE FOUNISSEUR'])
@section('style')
@endsection
@section('admin-content')
    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                <form class="form form-vertical" method="POST" action="{{ route('suppliers.store') }}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row match-height">
                        <div class="col-md-4 col-12" id="status_client_div" style="display: none">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <select class="form-select-reglement form-control" name="reglement"
                                                    id="reglement">
                                                    <option value="Prepaye" selected>Prepayé</option>
