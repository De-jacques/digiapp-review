@extends('pages.back.admin.master', ['titre' => 'EDITION DE FOURNISSEUR'])
@section('style')
@endsection
@section('admin-content')
    ...
    <div class="card">
        <div class="p-3 d-flex justify-content-between">
            <div>
                <a class="btn btn-outline-danger" href="{{ route('suppliers.index') }}">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form class="form form-vertical" method="POST" action="{{ route('suppliers.update', $supplier->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <select class="form-select-domiciliation form-control" name="domiciliation"
                                                    id="domiciliation">
                                                    <option value="Locale"
                                                        {{ $supplier->domiciliation == 'Locale' ? 'selected' : '' }}
                                                        selected>
                                                        Locale</option>
                                                    <option value="Etrangere"
                                                        {{ $supplier->domiciliation == 'Etrangere' ? 'selected' : '' }}>
                                                        Etrangère</option>
                                                </select>
                                                @error('domiciliation')
                        ...
                        <div class="col-md-2 col-12">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="reglement">Reglement (
                                                <span class="text-danger"> *</span>
                                                )</label>
                                            <div class="form-group">
                                                <select class="form-select-reglement form-control" name="reglement"
                                                    id="reglement">
                                                    <option value="Prepaye"
                                                        {{ $supplier->reglement == 'Prepaye' ? 'selected' : '' }} selected>
                                                        Prepayé</option>
                                                    <option value="Postpaye"
                                                        {{ $supplier->reglement == 'Postpaye' ? 'selected' : '' }}>
                                                        Postpayé</option>
                                                </select>
                                                @error('reglement')
                                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        {{-- <div class="col-md-2 col-12">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="type">Type de Fournisseur (
                                                <span class="text-danger"> *</span>
                                                )</label>
                                            <div class="form-group">
                                                <select class="form-select-type form-control" name="type" id="type">
                                                    <option value="Normal"
                                                        {{ $supplier->type == 'Normal' ? 'selected' : '' }} selected>Normal
                                                    </option>
                                                    <option value="Partenaire"
                                                        {{ $supplier->type == 'Partenaire' ? 'selected' : '' }}>Partenaire
                                                    </option>
                                                    <option value="Goov"
                                                        {{ $supplier->type == 'Goov' ? 'selected' : '' }}>
                                                        Goov</option>
                                                </select>
                                                @error('type')
                                                    <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="hidden" id="tvaValue" value="{{ $supplier->taxe_tva }}">
                            ...
                            <div class="form-group">
                                <div class="mb-3 col-12">
                                    ...
                                    @if (isset($supplier->exo_path))
                                        ...
                                        <input type="hidden" id="exo_path" value="{{ $supplier->exo_path }}">
                                    @else
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control custom-file-input"
                                                        ...
                                                        value="{{ $supplier->rcc_number }}" />
                                                    <div class="input-group-append">
                                                        @if (isset($supplier->rcc_path))
                                                            <label
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control custom-file-input"
                                                        ...
                                                        oninput="convertToUppercase(this)"
                                                        value="{{ $supplier->rcm_number }}" />
                                                    <div class="input-group-append">
                                                        @if ($supplier->rcm_path)
                                                            <label
                                                                class="input-group-text btn btn-success custom-file-label"
                                                                for="rcm_file">
                                                                <i class="fas fa-recycle"></i> Remplacer
                                ...
                                <div class="input-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="regime" id="inlineRadio1"
                                            value="TEE" {{ $supplier->regime == 'TEE' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="regime" id="inlineRadio2"
                                            value="RME" {{ $supplier->regime == 'RME' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="regime" id="inlineRadio3"
                                            value="RSI" {{ $supplier->regime == 'RSI' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="email-id-vertical" class="form-control"
                                                name="email" placeholder="Email" value="{{ $supplier->email }}">
                                            @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="solde" class="form-control" name="balance"
                                                placeholder="Solde départ" value="{{ $supplier->balance }}">
                                            @error('balance')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control"
                                                name="country" placeholder="Pays" value="{{ $supplier->country }}">
                                            @error('country')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control"
                                                name="city" placeholder="Ville" value="{{ $supplier->city }}">
                                            @error('city')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
    ...
    <script>
        $(function() {
            ...
            $("#domiciliation").change(function() {
                ...
                console.log("STATUS CHANGED " + select);
                if (select == 'Etrangere') {
                    // Obtenir la valeur courante de la TVA
                    var tvaValue = $("input[name='tva_status']:checked").val();
                    if (tvaValue == 'Non') {
                        // Si la domiciliation est étrangère et la TVA est "Non", définissez la TVA sur "Oui"
                        $("input[name='tva_status'][value='Oui']").prop('checked', true);
                        // Cachez le div tva_div
                        $("#tva_div").hide();
                        $("#docsTva").hide();
                    } else {
                        // Sinon, montrez le div tva_div
                        $("#tva_div").show();
                    }

                    // Masquez d'autres éléments si nécessaire
                    $("#regime_div").hide();
                    replaceClass("telephone_div", "col-md-2", "col-md-4");
                    replaceClass("solde_div", "col-md-2", "col-md-4");
                } else {
                    // Si la domiciliation n'est pas étrangère, montrez le div tva_div
                    $("#tva_div").show();
                    $("#regime_div").show();
                    replaceClass("telephone_div", "col-md-4", "col-md-2");
                    replaceClass("solde_div", "col-md-4", "col-md-2");
