@extends('pages.back.admin.master', ['titre' => 'GESTION DES CLIENTS'])
@section('style')
    <style>
    </style>
@endsection
                                                ...
                                                @isset($clients)
                                                    @foreach ($clients as $key => $client)
                                                        <tr>
                                                            ...
                                                            <td class="text-uppercase">{{ $client->nom }}</td>
                                                            ...
                                                            <td class="">
                                                                ...
                                                                <a type="button" class="btn btn-outline-warning"
                                                                    href="{{ route('customers.edit', $client->id) }}">
                                                                        ...
                                                                        <form class="form-horizontal">
                                                                            ...
                                                                            <div class="form-control-group mb-4">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div
                                                                                        class="form-control-group col-md-2 mb-3">
                                                            ...
                                                            <div class="modal fade text-left" id="edit{{ $client->id }}"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('customers.update', $client->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PUT')
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('customers.destroy', $client->id) }}"
                                                                            method="Post">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
