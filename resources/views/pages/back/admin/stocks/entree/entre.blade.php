@extends('pages.back.admin.master', ['titre' => 'GESTION DES BON DE RECEPTIONS'])
                        ...
                        <div class="card mb-0">
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                    ...
                                    <div class="card-body">
                                        <a href="{{ route('stock.newEntre') }}">
                                            <button type="button" class="btn btn-outline-primary newProduct mb-3 ">
                                                <i class="fa fa-plus"></i> Bon de reception
                                            </button>
                                        </a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{ $item->getProvider($item->provider_id) }}
                                                            @else
                                                            {{ $item->getSupplier($item->supplier_id) }}
                                                            @endif
                                                        </td>
                                                        <td>
                                                            {{"Numéro facture"}}
                                                        ...
                                                        <td>
                                                            <a href="{{ route('serial-number.edit', $item->ref_entree) }}"
                                                                class="btn btn-outline-default {{ $item->isSnComplete($item->ref_entree) ? '' : 'incomplete-sn-button' }}">
                                                                <i class="fa fa-chain"></i>
                                                            </a>

                                                            <a href="{{ route('entree.imprimer',$item->ref_entree) }}"
                                                            ...
                                                            <div class="modal fade" id="delete{{$item->id}}"
                                                                tabindex="-1" aria-labelledby="delete{{$item->id}}Label"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('entree.destroy', $item->id) }}"
                                                                                method="Post">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
