...
<body>
    ...
    <main>
        <div class="">
            ...
            <div class="informations">
                ...
                <div class="mt-3 text-right">
                    ...
                    @if (isset($fournisseur->ville, $fournisseur->pays))
                    <br>
                    ...
                    <div class="content row col-md-12" style="display: flex;justify-content: flex-right;" left=50%>
                        <div class="section col-md-4" style="">
                            <div class="mt-2">
                                ...
                                <br>
                                @if (isset($sign))
                                <img class="mt-3" src="{{ public_path('storage/'.$sign) }}" alt="" width="250px">
                                @else
        ...
        <div class="serial-number-list">
            <h2 class="text-uppercase text-center">Numéros de série</h2>
