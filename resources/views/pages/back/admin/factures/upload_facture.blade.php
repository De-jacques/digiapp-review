@extends('pages.back.admin.master', ['titre' => 'TÉLÉVERSER FACTURE'])
@section('style')
@endsection
@section('admin-content')
    ...
    <div class="card">
        <div class="p-3 d-flex justify-content-between">
            <div>
                <a class="btn btn-outline-danger" href="{{ route('factures.index') }}">
        ...
        <div class="card-content">
            <div class="card-body">
                <form class="form form-vertical" method="POST" action="{{ route('factures.store') }}"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="domiciliation">Numéro Facture</label>
                                            <div class="form-group">
                                               <input type="text" name="refFacture" class="form-control @error('refFacture') is-invalid @enderror" value="" id="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="reglement">Uploader la facture</label>
                                            <div class="form-group">
                                                <input class="form-control" name="uploadInvoice" type="file">
                                            </div>
                                        </div>
                                    </div>
                                </div>
